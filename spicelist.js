const PAGE_ID = 'spiceList';
const button = document.getElementById('addItem');
const shoppingList = document.getElementById('spiceitems');
let userTextInput = document.getElementById('spicelist-text-input');
let userQuantityInput = document.getElementById('spicelist-quantity-input');
