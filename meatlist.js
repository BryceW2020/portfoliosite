const PAGE_ID = 'meatList';
const button = document.getElementById('addItem');
const shoppingList = document.getElementById('meatitems');
let userTextInput = document.getElementById('meatlist-text-input');
let userQuantityInput = document.getElementById('meatlist-quantity-input');
