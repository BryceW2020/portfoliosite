const PAGE_ID = 'cleaningList';
const button = document.getElementById('addItem');
const shoppingList = document.getElementById('cleaningitems');
let userTextInput = document.getElementById('cleaninglist-text-input');
let userQuantityInput = document.getElementById('cleaninglist-quantity-input');
